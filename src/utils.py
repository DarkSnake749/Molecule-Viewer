...
from panda3d.core import (
    Shader, ShadeModelAttrib, Material, GeomVertexFormat, GeomVertexData, Geom, GeomTriangles, GeomNode,
...
SHADER = shader = Shader.load(Shader.SL_GLSL, "shader/atom.vert", "shader/atom.frag")

def make_sphere(render, radius=1.0, color=(1, 0, 0, 1), slices=48, stacks=24):
    ...
    node.setAttrib(ShadeModelAttrib.make(ShadeModelAttrib.MSmooth))
    node.add_geom(geom)
